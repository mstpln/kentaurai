...
export function getStep3Prompt(provider='openai') {
  ...
  return [
    ...
    'REGLER:',
    '- Extern statistik används främst där den tillför information som KentaurAI saknar: källans "Alla starter", ROI, aktuell bana, årstid, V85/V86, spets, aktuell balans och aktuell vagn.',
    '- Tolka inte "Alla starter" som garanterad full karriärstatistik om källans population inte är verifierad; använd alltid angivet antal starter som denominator.',
