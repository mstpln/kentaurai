...
function periodOptions(){const [current,previous]=currentYears();return [['all','Alla'],[String(current),current+' (i år)'],[String(previous),previous+' (förra året)']]}
function raceScopeOptions(){return [['all','Alla'],['high_prize','Högre prissumma'],['weekday','Vardagstrav']]}
function methodOptions(){return [['all','Alla'],['auto','Auto'],['volt','Voltstart']]}
