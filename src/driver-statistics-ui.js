...
state.driverStatsFilters=state.driverStatsFilters||{period:'1y',raceScope:'all',trackId:'all',raceType:'all',breedType:'all',sex:'all',age:'all',startMethod:'all',distanceGroup:'all',voltLane:'all',handicapM:'all',minStarts:'all'};
...
function dToolbar(includeMinimum=true){return '<div class="driver-stats-toolbar"><div class="driver-stats-filter-grid">'+dField('Period','period',PERIODS)+dField('Loppnivå','raceScope',SCOPES)+dField('Bana','trackId',dTrackRows())+dField('Lopptyp','raceType',TYPES)+dField('Rastyp','breedType',BREEDS)+dField('Kön','sex',SEXES)+dField('Ålder','age',dAgeRows())+dField('Startmetod','startMethod',METHODS)+dField('Distans','distanceGroup',dDistanceRows())+dField('Voltspår','voltLane',VOLT)+dField('Tillägg','handicapM',dHandicapRows())+(includeMinimum?dField('Min starter','minStarts',MINIMUMS):'')+'</div></div>'}
