...
/* Keep the search centered while the settings control occupies the far-right header column. */
.top-inner{grid-template-columns:auto minmax(280px,680px) minmax(44px,1fr)!important}
/* The settings affordance is intentionally only the gear: no visible pill, border or background. */
...
/* Capture app navigation after the existing click handler has synchronously updated state. */
