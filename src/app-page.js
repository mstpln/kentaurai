...
<style>
:root{--bg:#0d0d0c;--panel:#161614;--line:#2a2925;--text:#f4f0e8;--muted:#9d988f;--gold:#d6ab68}
...
<title>KentaurAI</title>
<style>
:root{--bg:#0d0d0c;--panel:#151513;--panel2:#1c1b18;--line:#2e2c27;--text:#f5f1e9;--muted:#969188;--muted2:#6f6b64;--gold:#d4aa67;--beige:#d8c7ae;--blue:#55769a;--yellow:#e4c65b;--radius:18px;--shadow:0 16px 45px rgba(0,0,0,.25)}
*{box-sizing:border-box}html{background:var(--bg)}body{margin:0;background:var(--bg);color:var(--text);font:14px/1.45 -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;min-height:100vh}button{font:inherit}button:focus{outline:none}button:focus-visible{outline:2px solid var(--blue);outline-offset:2px}.shell{min-height:100vh;padding-bottom:92px}.topbar{position:sticky;top:0;z-index:40;background:rgba(13,13,12,.94);backdrop-filter:blur(18px);border-bottom:1px solid rgba(46,44,39,.8)}.top-inner{max-width:1180px;margin:auto;padding:12px 18px;display:grid;grid-template-columns:auto minmax(180px,620px) auto;align-items:center;gap:16px}.brand{display:flex;align-items:center;gap:9px;min-width:max-content}.brand-mark{width:34px;height:34px;color:var(--gold)}.brand-name{font:600 21px/1 Georgia,serif;letter-spacing:-.02em}.brand-name span{color:var(--gold)}.search-wrap{position:relative}.search{width:100%;height:42px;border-radius:14px;border:1px solid var(--line);background:#171715;color:var(--text);padding:0 42px;font:inherit;outline:none}.search:focus{border-color:#6a5944;background:#1a1917}.search-icon{position:absolute;left:14px;top:12px;color:var(--muted);font-size:17px}.search-clear{position:absolute;right:8px;top:7px;width:28px;height:28px;border:0;border-radius:9px;background:transparent;color:var(--muted);cursor:pointer;font-size:18px}.logout{border:1px solid var(--line);background:transparent;color:var(--muted);border-radius:11px;padding:8px 10px;cursor:pointer}.search-results{position:absolute;left:0;right:0;top:48px;background:#181816;border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);overflow:hidden;display:none}.search-results.open{display:block}.search-item{display:flex;justify-content:space-between;gap:12px;padding:11px 13px;border-bottom:1px solid #26241f;cursor:pointer}.search-item:last-child{border-bottom:0}.search-item:hover{background:#211f1b}.search-type{color:var(--gold);font-size:12px;text-transform:uppercase;letter-spacing:.05em}.main{max-width:1180px;margin:auto;padding:24px 18px}.page-heading{margin-bottom:20px}.page-heading h1{font-size:29px;letter-spacing:-.035em;margin:0}.page-heading p{margin:4px 0 0;color:var(--muted)}.eyebrow{color:var(--gold);font-size:11px;text-transform:uppercase;letter-spacing:.12em;font-weight:700}.tabs{display:flex;gap:5px;padding:4px;background:#171715;border:1px solid var(--line);border-radius:14px;width:max-content;max-width:100%;overflow:auto;margin-bottom:18px;scrollbar-width:none}.tab{border:0;background:transparent;color:var(--muted);padding:9px 15px;border-radius:10px;white-space:nowrap;font-weight:600;cursor:pointer}.tab.active{background:var(--beige);color:#211b15}.grid{display:grid;gap:14px}.grid-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-2{grid-template-columns:repeat(2,minmax(0,1fr))}.card{background:var(--panel);border:1px solid var(--line);border-radius:var(--radius);overflow:hidden}.card-pad{padding:18px}.card-title{font-weight:700;font-size:15px}.metric{font-size:30px;font-weight:750;letter-spacing:-.04em;margin-top:12px}.metric-note{font-size:12px;color:var(--muted);margin-top:3px}.accent-gold{border-top:2px solid var(--gold)}.accent-blue{border-top:2px solid var(--blue)}.accent-yellow{border-top:2px solid var(--yellow)}.section-title{display:flex;justify-content:space-between;align-items:center;margin:4px 0 10px}.section-title h2{font-size:16px;margin:0}.section-title span{color:var(--muted);font-size:12px}.table-wrap{overflow:auto}.table{width:100%;border-collapse:collapse}.table th{font-size:11px;text-transform:uppercase;letter-spacing:.06em;text-align:left;color:var(--muted);font-weight:650;padding:11px 14px;border-bottom:1px solid var(--line);background:#121210}.table td{padding:13px 14px;border-bottom:1px solid #27251f}.table td:last-child,.table th:last-child{text-align:right;width:48px}.table tr:last-child td{border-bottom:0}.table tbody tr{cursor:pointer}.table tbody tr:hover{background:#1b1a17}.empty{padding:32px 18px;text-align:center;color:var(--muted)}.empty strong{display:block;color:var(--text);font-size:15px;margin-bottom:5px}.status-list{display:grid;gap:9px}.status-row{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:12px 0;border-bottom:1px solid var(--line)}.status-row:last-child{border-bottom:0}.dot{width:8px;height:8px;border-radius:50%;background:var(--gold);display:inline-block;margin-right:8px}.dot.muted{background:var(--muted2)}.bottom-nav{position:fixed;z-index:50;left:0;right:0;bottom:0;background:rgba(13,13,12,.96);backdrop-filter:blur(18px);border-top:1px solid var(--line);padding:7px max(10px,env(safe-area-inset-right)) calc(7px + env(safe-area-inset-bottom)) max(10px,env(safe-area-inset-left))}.bottom-inner{max-width:650px;margin:auto;display:grid;grid-template-columns:repeat(4,1fr);gap:4px}.nav-item{border:0;background:transparent;color:#74716c;border-radius:13px;padding:7px 5px 6px;cursor:pointer;font-weight:600;font-size:11px}.nav-icon{font-size:20px;line-height:1;margin-bottom:4px;display:block}.nav-item.active{color:var(--gold);background:#1b1916}.detail-head{display:grid;grid-template-columns:72px 1fr;gap:16px;align-items:center;margin-bottom:18px}.avatar{width:72px;height:72px;border-radius:18px;border:1px solid var(--line);background:linear-gradient(135deg,#2d2923,#151513);display:grid;place-items:center;color:var(--gold);font:700 25px Georgia,serif}.detail-name{font-size:27px;font-weight:750;letter-spacing:-.035em}.detail-meta{color:var(--muted);margin-top:4px}.back{border:1px solid var(--line);background:#171715;color:var(--text);border-radius:11px;padding:8px 12px;cursor:pointer;margin-bottom:18px}.facts{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1px;background:var(--line);border:1px solid var(--line);border-radius:16px;overflow:hidden}.fact{background:var(--panel);padding:13px}.fact-label{font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.05em}.fact-value{margin-top:4px;font-weight:650}.link{color:var(--gold);cursor:pointer}.notice{border:1px solid #514737;background:#1c1914;padding:14px 15px;border-radius:14px;color:#c9c0b2}.skeleton{height:80px;border-radius:16px;background:linear-gradient(90deg,#171715,#211f1b,#171715);background-size:200% 100%;animation:pulse 1.3s infinite}@keyframes pulse{to{background-position:-200% 0}}
...
function entityRow(item){return '<tr data-id="'+esc(item.id)+'"><td><strong>'+esc(item.name)+'</strong></td><td>›</td></tr>'}
async function renderEntityList(page){state.detail=null;state.page=page;setNav(page);const data=await api('/entities/'+page);app.innerHTML=heading(labels[page],'Sök och utforska '+labels[page].toLowerCase())+tabs([['list','Lista'],['stats','Statistik']],state.tab);
 if(state.tab==='list')app.innerHTML+='<div class="card table-wrap"><table class="table"><thead><tr><th>Namn</th><th></th></tr></thead><tbody>'+data.items.map(entityRow).join('')+'</tbody></table></div>';
