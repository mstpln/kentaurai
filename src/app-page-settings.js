...
async function renderSettings(){if(typeof cancelRankingLifecycle==='function')cancelRankingLifecycle();if(typeof cancelEntityListLifecycle==='function')cancelEntityListLifecycle();state.settingsOpen=true;state.settingsTab='data';state.detail=null;state.gameDetail=null;state.gameSystemId=null;settingsButton.classList.add('active');clearMainNav();return renderData()}
